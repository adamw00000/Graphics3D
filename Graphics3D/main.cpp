...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (int i = 0; i < NR_POINT_LIGHTS; i++)
		{
			...
			lightingShader.setFloat(location + "].linear", 0.22f);
			lightingShader.setFloat(location + "].quadratic", 0.20f);
			lightingShader.setVec3(location + "].ambient", 0.2f, 0.2f, 0.2f);
			lightingShader.setVec3(location + "].diffuse", 0.5f, 0.5f, 0.5f);
			lightingShader.setVec3(location + "].specular", 1.0f, 1.0f, 1.0f);
		}
